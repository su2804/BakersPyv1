...
from PyQt5.QtWidgets import QMainWindow, QApplication, QLineEdit, QComboBox, QDialogButtonBox, QLabel, QDialog, QPushButton
...
class UI(QDialog):
    ...
    def process_files(self):
        ...
        #nd2 file metadata
        num_fovs = self.edit_numfovs.text()
        num_slices = self.edit_numslices.text()
        zspace = self.edit_zspace.text()
        ...
        #create subfolders to upload Results
        ...
        with open(output_path+'cell_size_state.csv', 'w') as csvfile:
            ...
            with ND2Reader(nd2_path) as images:
                ...
                for i in range((2*num_fovs*num_slices)+ceil(num_slices/2),(3*num_fovs*num_slices)-(num_slices-ceil(num_slices/2)),num_slices):
                    ...
                    try:
                        ...
                        if maskindex<11:
                            ...
                            #Channel 1 extraction - conversion of channel1 and cell zstack to a horizontal stack that can be analyzed later
                                ...
                                start_Index=i-(2*num_fovs*num_slices)+ceil(num_slices/2)-1; #channel 1 images start at index 1
                                ...
                                for k in range(start_Index+1,start_Index+num_slices): #add zslices horizontally
                                ...
                                masked_hstack = np.multiply(cell,img,c1_img) #create a cell-masked image of channel 1
                            ...
                            #Channel 2 extraction - conversion of channel1 and cell zstack to a horizontal stack that can be analyzed late
                                ...
                                start_Index=i-(2*num_fovs*num_slices)+ceil(num_slices/2)-(num_fovs*num_slices)-1; #channel 2 start index
                                cell_img=cleaned_img
                                ...
                                masked_hstack = np.multiply(cell,img,c2_img) #create a cell-masked image of channel 1
